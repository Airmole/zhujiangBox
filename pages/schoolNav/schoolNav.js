...
Page({
  ...
  data: {
    ...
    cost: '',
    polyline: [],
    userLongitude: 117.404968,
    userLatitude: 39.551223,
    inSchool: false,
    isLoading: true,
  },
  ...
  moveSchool: function() {
    ...
    var _this = this;
    _this.setData({
      userLongitude: 117.404861,
      userLatitude: 39.551197,
    })
  },
  jtt: function() {
    wx.previewImage({
